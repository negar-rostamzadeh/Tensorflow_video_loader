...
tfrecord_dir = '/mnt/AIDATA/anmol/kinetics_tfrecords' #where to write tfrecord files
error_file = '/home/anmol/projects/kinetics-baseline/tmp/errors_split_' + str(args.split) + '.txt' #errors logged here
success_file = '/home/anmol/projects/kinetics-baseline/tmp/success_split_' + str(args.split) + '.txt' #successes logged here
...
def write_kinetics_videos_tf_record(set_list, set_list_paths, dataset_dir, tfrecords_dir,error_file,success_file, name_to_int_path, split, shard_size=4, frames_keep = 25, dim_small_resize = 320, resample_freq = 25, video_format = ".mp4"):
    '''
    ...
    for set_name in set_list:
        ...
        i=i+1
        set_shuffled_list_path = './tmp/' + set_name +'split_'+str(split)+'.csv' #os.path.join(dataset_dir,set_name,set_name + '_shuffled' + '.csv')
...
if (__name__ == "__main__"):
    ...
    #kinetics
    write_kinetics_videos_tf_record(set_list, set_list_paths, dataset_dir, tfrecord_dir,error_file,success_file,name_to_int_path, split = args.split, shard_size = 1000)
